...
box1Para.innerText = "querySelector returns an element you can maupulate but querySelectorAll returns the collection of elements in array kind of structure.";

// Remove all the elements from box 1
let firstBox = document.querySelector(".one");
while(firstBox.firstChild){
  firstBox.removeChild(firstBox.lastChild)
};

// Replace all the elements inside box 1 with the para (you created above)
firstBox.append(box1Para);
...
let box2Para = document.createElement('p').innerText = "Append inserts as last child";
...
let box3Para = document.createElement('p').innerText = "Prepend inserts as first child";
let box3 = document.querySelector(".three");
box3.prepend(box3Para);
...
while(box7.firstChild){
  box7.removeChild(box7.lastChild)
};
